...
#[test]
fn test_sha1_abc() {
    let expected: [u8; 20] = hex::decode("a9993e364706816aba3e25717850c26c9cd0d89d")
        .unwrap()
        .try_into()
        .unwrap();
...
#[test]
fn test_sha512_abc() {
    let expected: [u8; 64] = hex::decode("ddaf35a193617abacc417349ae20413112e6fa4e89a97ea20a9eeee64b55d39a2192992a274fc1a836ba3c23a3feebbd454d4423643ce80e2a9ac94fa54ca49f")
        .unwrap()
        .try_into()
        .unwrap();
...
#[test]
fn test_sha384_abc() {
    let expected: [u8; 48] = hex::decode("cb00753f45a35e8bb5a03d699ac65007272c32ab0eded1631a8b605a43ff5bed8086072ba1e7cc2358baeca134c825a7")
        .unwrap()
        .try_into()
        .unwrap();
...
fn test_sha512_256_abc() {
    let expected: [u8; 32] =
        hex::decode("53048e2681941ef99b2e29b76b4c7dabe4c2d0c634fc6d46e0e2f13107e7af23")
            .unwrap()
            .try_into()
            .unwrap();
...
fn test_sha3_512_abc() {
    let expected: [u8; 64] = hex::decode("b751850b1a57168a5693cd924b6b096e08f621827444f70d884f5d0240d2712e10e116e9192af3c91a7ec57647e3934057340b4cf408d5a56592f8274eec53f0")
        .unwrap()
        .try_into()
        .unwrap();
...
fn test_blake2b_512_abc() {
    let expected: [u8; 64] = hex::decode("ba80a53f981c4d0d6a2797b69f12f6e94c212f14685ac4b74b12bb6fdbffa2d17d87c5392aab792dc252d5de4533cc9518d38aa8dbf1925ab92386edd4009923")
        .unwrap()
        .try_into()
        .unwrap();
